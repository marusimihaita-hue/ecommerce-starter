...
export function CheckoutClient() {
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <Button asChild className="mt-8">
            <Link href="/">Continuă cumpărăturile</Link>
          </Button>
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 pb-15">
      {/* Header */}
      <div className="mb-8">
        <Link
          href="/"
          ...
          <div className="rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
            ...
            {hasStockIssues && !isLoading && (
              <div className="mx-6 mt-4 flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-950/50 dark:text-amber-200">
                ...
                <span>
                  Există produse cu probleme de stoc. Te rugăm să actualizezi
                  coșul înainte de a continua.
                </span>
              </div>
            )}
                      ...
                      <div>
                        ...
                        {stockInfo?.exceedsStock && !stockInfo.isOutOfStock && (
                          <p className="mt-1 text-sm font-medium text-amber-600">
                            Doar {stockInfo.currentStock} disponibile
                          </p>
                        )}
                      </div>
                    </div>
